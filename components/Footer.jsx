      ...
      <footer className="text-gray-600">
              ...
              <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                  <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                      ...
                      <nav className="list-none mb-10">
                          ...
                          <li>
                              <a className="text-gray-600 hover:text-gray-800">Papers</a>
                          </li>
                          <li>
                              <a className="text-gray-600 hover:text-gray-800">Search by Categories</a>
                          </li>
                          <li>
          ...
          <div className="bg-gray-100">
              <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                  <p className="text-gray-500 text-sm text-center sm:text-left">© 2023 First Paper —
                      <a href="https://twitter.com/firstpaper" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@{name.toLowerCase()}</a>
                  </p>
