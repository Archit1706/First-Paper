        ...
        <header className="text-gray-600">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                <nav className="flex lg:w-2/5 flex-wrap items-center text-base md:ml-auto">
                    <a className="mr-5 hover:text-gray-900 cursor-pointer hover:shadow-md shadow-gray-500">Home</a>
                    <a className="mr-5 hover:text-gray-900 cursor-pointer hover:shadow-md shadow-gray-500">About</a>
                    <a className="mr-5 hover:text-gray-900 cursor-pointer hover:shadow-md shadow-gray-500">Papers</a>
                    <a className="mr-5 hover:text-gray-900 cursor-pointer hover:shadow-md shadow-gray-500">Search by Category</a>
                    <a className="hover:text-gray-900 cursor-pointer hover:shadow-md shadow-gray-500">Contact Us</a>
                </nav>
