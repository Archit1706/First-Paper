            ...
            <header className="text-gray-600 border-b border-gray-300">
                <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                    ...
                    <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
                        <a
                            className="mr-5 hover:text-gray-900 cursor-pointer hover:shadow-md shadow-gray-500"
                            href="#"
                        >
                            Home
                        </a>
                        ...
                        <a
                            className="hover:text-gray-900 cursor-pointer hover:shadow-md shadow-gray-500"
                            href="#contact"
                        >
                            Contact Us
                        </a>
